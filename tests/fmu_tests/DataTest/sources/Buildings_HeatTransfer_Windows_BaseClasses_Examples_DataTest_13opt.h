  ...
  extern "C" {
#endif
  int Buildings_HeatTransfer_Windows_BaseClasses_Examples_DataTest_mayer(DATA* data, modelica_real** res, short*);
  int Buildings_HeatTransfer_Windows_BaseClasses_Examples_DataTest_lagrange(DATA* data, modelica_real** res, short *, short *);
