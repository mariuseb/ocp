  ...
  extern "C" {
#endif
  int Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit_mayer(DATA* data, modelica_real** res, short*);
  int Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit_lagrange(DATA* data, modelica_real** res, short *, short *);
