...
#else
  #define OMC_FILE "/home/marius/fmu_test/buildopt/test/Buildings.HeatTransfer.Windows.Examples.WinRadCustomWea/Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea.fmutmp/sources/Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea_13opt.c"
#endif
/* Optimization */
...
extern "C" {
#endif
int Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea_mayer(DATA* data, modelica_real** res,short *i) {
...
int Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
