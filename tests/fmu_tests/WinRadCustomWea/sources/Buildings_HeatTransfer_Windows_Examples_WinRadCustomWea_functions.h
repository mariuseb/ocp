#ifndef Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea__H
#define Buildings_HeatTransfer_Windows_Examples_WinRadCustomWea__H
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_Buildings_HeatTransfer_Windows_BaseClasses_smoothInterpolation,2,0) {(void*) boxptr_Buildings_HeatTransfer_Windows_BaseClasses_smoothInterpolation,0}};
#define boxvar_Buildings_HeatTransfer_Windows_BaseClasses_smoothInterpolation MMC_REFSTRUCTLIT(boxvar_lit_Buildings_HeatTransfer_Windows_BaseClasses_smoothInterpolation)
