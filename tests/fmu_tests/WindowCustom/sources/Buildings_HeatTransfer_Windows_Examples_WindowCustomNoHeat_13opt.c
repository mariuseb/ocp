...
#else
  #define OMC_FILE "/home/marius/fmu_test/buildopt/test/Buildings.HeatTransfer.Windows.Examples.WindowCustomNoHeat/Buildings_HeatTransfer_Windows_Examples_WindowCustomNoHeat.fmutmp/sources/Buildings_HeatTransfer_Windows_Examples_WindowCustomNoHeat_13opt.c"
#endif
/* Optimization */
...
extern "C" {
#endif
int Buildings_HeatTransfer_Windows_Examples_WindowCustomNoHeat_mayer(DATA* data, modelica_real** res,short *i) {
...
int Buildings_HeatTransfer_Windows_Examples_WindowCustomNoHeat_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
