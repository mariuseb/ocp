...
if __name__ == "__main__":
  ...
  path = os.path.join(get_opt_config_path(), "param_est_config_coll_linear.json")
  ...
  """
  idas_map = IDA.one_sample.mapaccum("idas_test", N)
  res = idas_map(x0=X, z0=0, p=ca.repmat(param_truth, 1, N), u=u_data)["xf"]
