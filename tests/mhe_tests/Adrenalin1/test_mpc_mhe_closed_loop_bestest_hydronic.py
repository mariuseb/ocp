...
if __name__ == "__main__":
    ...
    # write info to files:
    from pprint import pprint
    with open('adrenline1_meas_info.txt', 'wt') as out:
        pprint(boptest.get_measurement_info(), stream=out)
    with open('adrenline1_input_info.txt', 'wt') as out:
        pprint(boptest.get_input_info(), stream=out)
    with open('adrenline1_forecast_info.txt', 'wt') as out:
        pprint(boptest.get_forecast_info(), stream=out)
