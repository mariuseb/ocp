...
if __name__ == "__main__":
    ...
    for k in range(K):
        ...
        if k >= (mhe.N - 1):
            ...
            time.loc[k] = mpc.solver.stats()["t_wall_total"] \
                          + \
                          mhe.solver.stats()["t_wall_total"]
            
            
            """
            params_lb[0] = params_lb[0]*0.7
            params_ub[0] = params_ub[0]*1.3
            
            sol_mhe, params_mhe_free, raw_sol_mhe_free = mhe.solve(
                y_data,
                params,
                lbp=params_lb,
                ubp=params_ub,
            ...
            #params_lb[0] = params_lb[0]*0.7
            #params_ub[0] = params_ub[0]*1.3
            #params_lb[4] = params[4]*0.7
            #params_ub[4] = params[4]*1.3
    ...
    ax = mhe.df.Ti.plot(label="estimated")
    df.loc[mhe.df.index].Ti.plot(ax=ax, label="true")
    ax.legend()
    plt.show()
