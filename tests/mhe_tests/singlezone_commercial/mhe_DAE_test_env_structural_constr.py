...
if __name__ == "__main__":
    ...
    mhe_cfg = os.path.join("mhe_configs", "6R4C_MHE_ENV_no_CO2_structural_constr.json")
    ...
    kwargs = {
        "slack": True,
        "p_nom": np.array([1.e+04, 1.e+00, 1.e+00, 1.e+02, 1.e+02, 1.e+03, 1.e+00, 1.e+02, \
       1.e-04, 1.e-06, 1.e+00, 1.e+00, 1.e+00, 1.e+00, 1.e+00, 1.e+01, \
       1.e+01, 1.e+01, 1.e+00, 1.e+03, 1.e+05, 1.e-03, 1.e-04, 1.e-02, \
       1.e-05, 1.e-03, 1.e-03, 1.e-05, 1.e+01, 1.e-01, 1.e-06, 1.e+07, \
       1.e+07, 1.e+07, 1.e+06, 1.e+06, 1.e+02, 1.e+00, 1.e-01, 1.e+01, \
       1.e-05, 1.e+03, 1.e+00, 1.e-03])
        }
    ...
    R[1,1] = 1/1E-2
    R[2,2] = 1/1E-9
    Q = ca.DM.eye(mhe.n_x + mhe.n_z)*1E3
    ekf.set_params(params)
    ekf.set_R(R)
    ekf.set_Q(Q)
