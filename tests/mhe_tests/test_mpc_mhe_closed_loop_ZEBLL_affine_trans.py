...
if __name__ == "__main__":
    ...
    mhe_cfg = os.path.join(opt_config_base, "2R2C_MHE_stoch.json")
    ...
    mhe = MHE(config=mhe_cfg, **deepcopy(kwargs))
    mpc = MPC(config=mpc_cfg, **deepcopy(kwargs)) # to remove, replace with N
