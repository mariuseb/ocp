...
if __name__ == "__main__":
    ...
    mpc_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_HVAC_MPC.json")
    ...
    ekf_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_HVAC_EKF.json")
    mhe_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_MHE.json")
    ...
    for k in range(K):
        ...
        if k >= mhe.N:
            ...
            y_data = boptest.get_data(ts=start_time - boptest.h, tf=stop_time)
            y_data["y1"] = y_data.Ti
