...
if __name__ == "__main__":
    ...
    mhe_cfg = os.path.join(opt_config_base, "3R3C_MHE.json")
    ...
    params = ca.DM([0.01,0.1,0.01,1E6,1E6,1E6,5,39.1])
    ...
    x0 = np.array([293.05, 290.15, 300.15])
    #x0 = np.array([294.05, ])
    #y_prev = x0[0]
    # sim horizon: 2 days
    days = 31
