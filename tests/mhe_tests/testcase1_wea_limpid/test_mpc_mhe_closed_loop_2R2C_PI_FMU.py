...
if __name__ == "__main__":
    ...
    #mpc_cfg = os.path.join(opt_confi2C_bestest_air_MPC_2meas.json")
    #mpc_cfg = os.path.join(opt_config_base, "2Rg_base, "3R3C_bestest_air_MPC.json")
    mpc_cfg = os.path.join("mpc_configs", "3R2C_LimPID_FMU_MPC.json")
    mhe_cfg = os.path.join("mhe_configs", "2R2C_LimPID_MHE_1meas.json")
    #mpc_cfg = os.path.join(opt_config_base, "3R2C_MPC_idas.json")
