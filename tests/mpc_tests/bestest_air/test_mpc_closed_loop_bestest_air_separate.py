...
if __name__ == "__main__":
    ...
    #mpc_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_MPC.json")
    #mpc_cfg = os.path.join(opt_config_base, "2R2C_MPC.json")
    mpc_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_separate_MPC.json")
    ...
    ekf_cfg = os.path.join(opt_config_base, "3R2C_bestest_air_separate_EKF.json")
