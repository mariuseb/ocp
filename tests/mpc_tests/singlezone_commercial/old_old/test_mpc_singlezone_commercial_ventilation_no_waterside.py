...
if __name__ == "__main__":
    ...
    params = np.array([7.65208454e-05,
                       1.65686713e-03,
                       3.59677263e-04,
                       3.06626303e-01,
                       4.33349565e+07,
    ...
    y_pred = pd.DataFrame(columns=ekf.y)
    ...
    for k in range(K):
        ...
        y_pred.loc[mpc.dt*k] = sol[ekf.y].iloc[0].values
    ...
    """
    Look at difference P_vent_hat , P_vent_meas:
    """
    ax = y_pred.Pvent.plot()
    y_hist.Pvent.plot(ax=ax)
    plt.show()
