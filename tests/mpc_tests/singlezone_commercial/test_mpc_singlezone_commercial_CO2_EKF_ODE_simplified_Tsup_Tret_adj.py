...
if __name__ == "__main__":
    ...
    mpc_cfg = os.path.join("mpc_configs", "6R5C_MPC_ENV_no_CO2_adj.json")
    boptest_cfg = os.path.join(bop_config_base, "ZEBLL_config.json")
    ekf_cfg = os.path.join("ekf_configs", "6R5C_EKF_ENV_no_CO2_ODE_adj_adj.json")
    
    #params_hvac = pd.read_csv("HVAC_model_latest.csv", index_col=0)
    params_hvac = pd.read_csv("HVAC_DAE_model_latest_Tsup_Tret.csv", index_col=0)
    ...
    kwargs = {
        "x_nom": [12,12,12,12,12],
        "x_nom_b": [289.15,289.15,289.15,289.15,289.15],
        "z_nom": [1E6,1],
        "z_nom_b": [0,0],
    ...
    x0 = np.array([293.15,293.15,293.15,293.15,293.15])
