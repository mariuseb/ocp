...
if __name__ == "__main__":
    ...
    mpc_hvac_cfg = os.path.join("mpc_configs", "HVAC_MPC_no_CO2_adj.json")
    ...
    params_hvac = pd.read_csv("HVAC_DAE_model_latest_Tret_old.csv", index_col=0)
    ...
    for k in range(K):
        ...
        Set Ti, Prad_to_env
        """
        sol = pd.read_csv("whole_day.csv", index_col=0)
        sol["Prad_to_env_decomp"] = sol_env.Prad_to_env
        ...
        sol["Ti_decomp"] = sol_env["Ti"]
        #params_env[-1] = sol_hvac["Prad_to_env"][1]
