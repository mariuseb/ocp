...
if __name__ == "__main__":
    ...
    for k in range(K):
        ...
        """
        if k % 15 == 0: # calculate optimal actions
            ...
            #data_env = data[0:mpc_env.N*mpc_env.dt:mpc_env.dt]
            inds = [ndx for ndx in data.index if ndx % 900 == 0]
            data_env = data.loc[inds]
            ...
            data_hvac["Trad_MPC"] = 0
            data_hvac["Ti"][0] = sol_env.Ti[0]
            data_hvac.Ti.iloc[-1] = sol_env.Ti.iloc[1]
            ...
            #lbx_hvac[3:-1:4] = 300
            #ubx_hvac[3:-1:4] = 800
            params_hvac[-1] = float(sol_env.Prad_to_env[0])
            ...
            u_hvac.loc["rad_val"] = sol_hvac.loc[int(k % 15), "rad_val"]
