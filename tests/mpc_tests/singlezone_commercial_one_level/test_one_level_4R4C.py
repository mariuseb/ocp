...
if __name__ == "__main__":
    ...
    mpc_env_cfg = os.path.join("mpc_configs", "4R4C_MPC_one_level.json")
    ...
    _res = res.iloc[:-1].copy()
    ekf_env.df.index = _x_model.index
    ekf_env.df["Ti_model"] = _x_model["Ti"]
    ekf_env.df["Ti_meas"] = _res["Ti"]
