...
if __name__ == "__main__":
    ...
    mpc_hvac_cfg = os.path.join("mpc_configs", "HVAC_MPC_no_CO2_adj_Tsup_900s_rad_flo_ext.json")
    ...
    x0_hvac = np.array([290.15,290.15,328.5])
    ...
    for k in range(K):
        ...
        if k % 1 == 0:
            ...
            params_hvac[-2] = sol_env.Prad_to_env.iloc[0].astype(float)
            params_hvac[-1] = sol_env.Prad_to_env.iloc[1].astype(float)
