...
if __name__ == "__main__":
    ...
    mpc_env_cfg = os.path.join("mpc_configs", "3R3C_MPC_ref_tracking.json")
    ...
    for k in range(K):
        ...
        if k % 5 == 0:
            ...
            x0_hvac = sol_hvac.loc[5, mpc_hvac.x_names].values
            # store results:
            ...
            x_model.loc[int(k/5) + 1, mpc.x_names] = sol_env.iloc[1][mpc.x_names]
            x_model.loc[int(k/5) + 1, mpc_hvac.x_names] = sol_hvac.iloc[1][mpc_hvac.x_names]
