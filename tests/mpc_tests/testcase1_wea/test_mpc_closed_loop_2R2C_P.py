...
if __name__ == "__main__":
    ...
    mpc_cfg = os.path.join(opt_config_base, "2R2C_P_MPC_1meas.json")
    ...
    ekf_cfg = os.path.join(opt_config_base, "2R2C_P_EKF_1meas.json")
    ...
    """
    params = ca.DM([0.01,0.01,1E6,5E6,2000])
