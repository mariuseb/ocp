...
if __name__ == "__main__":
    ...
    mpc_cfg_symb = os.path.join("mpc_configs", "2R2C_PI_MPC_1meas_Ai_DAE.json")
    ...
    #params = ca.DM([0.01,0.01,1E6,5E6,5,2000])
    ...
    mpc_sym = MPC(config=mpc_cfg_symb,
                  param_guess=params, 
                  functions=functions,
                  **deepcopy(kwargs))  # to remove, replace with N
    ...
    x0 = x0_all = np.array([293.15, 293.15, 0])
