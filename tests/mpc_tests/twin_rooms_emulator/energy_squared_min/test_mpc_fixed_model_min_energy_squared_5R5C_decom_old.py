...
if __name__ == "__main__":
    ...
    # config:
    mpc_env_cfg = os.path.join("mpc_configs", "3R3C_MPC_env.json")
    mpc_rad_cfg = os.path.join("mpc_configs", "2R2C_MPC_rad.json")
    ...
    x0_env = np.array([293.15,293.15,293.15])
