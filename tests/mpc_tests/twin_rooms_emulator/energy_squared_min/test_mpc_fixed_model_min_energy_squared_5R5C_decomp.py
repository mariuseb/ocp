...
if __name__ == "__main__":
    ...
    # config:
    mpc_env_cfg = os.path.join("mpc_configs", "2R2C_MPC_env_no_constr.json")
    mpc_rad_cfg = os.path.join("mpc_configs", "3R3C_MPC_rad.json")
    ...
    for k in range(K):
        ...
        data_rad["Trad_ENV"] = sol_env["Trad"][0:mpc_rad.N].values
        data_rad["Ti_ENV"] = sol_env["Ti"][0:mpc_rad.N].values
