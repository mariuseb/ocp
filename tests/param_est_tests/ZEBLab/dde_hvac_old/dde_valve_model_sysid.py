...
# only tau, delay
param_guess = np.array([150,150,1])
...
with ParameterEstimation(config=cfg_path,
    ...
    sol["u_val_set"].plot(color="g", ax=ax, linestyle="dashed")
