...
# only tau, delay
param_guess = np.array([150,0.03, 4200])
...
cfg_path = "configs/DDE_valve_2state_m_flow_power.json"
...
with ParameterEstimation(config=cfg_path,
    ...
    ax = sol["Prad"].plot(drawstyle="steps-post", color="r")
    sol["y4"].plot(color="k", drawstyle="steps-post", ax=ax)
