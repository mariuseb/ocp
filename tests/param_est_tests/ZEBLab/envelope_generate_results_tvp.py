...
ekf_config = "configs/ekf_configs/4R3C_envelope_EKF.json"
...
result_gen.make_journal_plot(
                             y_data,
                             x0, 
                             "tvp_journal_plot_training"
                             )
result_gen.plot_residual_dist(
                              y_data,
                             "tvp_residual_plot_training"
                             )
...
result_gen.make_journal_plot(
                             y_data,
                             x0, 
                             "tvp_journal_plot_validation"
                             )
result_gen.plot_residual_dist(
                              y_data,
                             "tvp_residual_plot_validation"
                             )
