...
params = pd.DataFrame(pd.read_csv("results/params_envelope_tvp_2R2C_vent_no_conns.csv", index_col=0))
# to get estimated x0, read trajectory:
sol = pd.read_csv("results/tvp_in_training_traj_2R2C_vent_no_conns.csv", index_col=0)
...
result_gen = ResultGenerator(
                             config="configs/2R2C_det_vent_tvp_vent_cond_no_constr_no_adj_conns.json",
                             params=params,
                             dt=3600
                            )
