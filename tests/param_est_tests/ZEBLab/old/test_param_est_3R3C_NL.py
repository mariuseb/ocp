...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "3R3C_det_NL.json")
    ...
    start = pd.Timestamp("2022-12-02 00:00")
    stop = pd.Timestamp("2022-12-22 00:00")
    ...
    param_guess = ca.DM([0.001,0.01,0.001,0.1,1E6,1E2,1E6,1E2,1E5,2,1,1])
