...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "3R3C_det_vent_no_conns.json")
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        plt.show()
        params.to_csv("results/params_envelope_linear.csv", index=True)
        print(params)
    # dump for plots:
    sol.to_csv("results/L_in_training_traj.csv", index=True)
    ...
    #plt.show()
    res.to_csv("results/L_validation_traj.csv", index=True)
