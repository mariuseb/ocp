...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "Tret_Tsup_Prad_flow_alt.json")
    ...
    ax1 = ax.twinx()
    Tdata.fall.plot(ax=ax1, color="k", linestyle="dashed", linewidth=0.7, drawstyle="steps-post")
    ...
    x_guess = data[["Tsup", "Tret","u_val_set"]].values
