...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "heating_curve_1state_ODE.json")
    ...
    stop = pd.Timestamp("2022-12-31 00:00")
    ...
    """
    Resample to 15 mins, investigate fit of regNonZeroPower
    """
    ...
    ax = axes[0]
    ax1 = ax.twinx()
    data.P_rad_219.plot(ax=ax1, color="r", linewidth=0.5, drawstyle="steps-post")
    data.T_amb.plot(ax=ax, drawstyle="steps-post")
    ax.set_ylim([-15,0])
    ax = axes[1]
