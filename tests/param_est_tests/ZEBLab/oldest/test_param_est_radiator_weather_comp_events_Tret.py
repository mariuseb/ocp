...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "Tret_no_if_else_ODE.json")
    ...
    stop = pd.Timestamp("2023-06-01 00:00")
    ...
    data["m_flow_bool"] = data["V_flow_219"].astype(bool).astype(int) #.shift(-2)
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        Tsup = sol["Tret"].sort_values(ascending=False)
