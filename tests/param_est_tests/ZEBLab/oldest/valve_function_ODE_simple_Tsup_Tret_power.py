...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "valve_ODE_simple_Tsup_Tret_Prad.json")
    ...
    ubp[len_p-2] = 7
    """    
    x_guess = data[["Tsup", "u_val_set", "Tret"]].values
    #lbx = 0.8*x_guess
    #ubx = 1.2*x_guess
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = sol["Prad"].plot(linewidth=0.75, drawstyle="steps-post", color="k")
