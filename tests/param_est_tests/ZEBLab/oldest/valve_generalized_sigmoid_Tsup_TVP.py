...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "Tsup_rise_gen_sigmoid.json")
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        # power:
        ax = sol["y3"].plot(linewidth=0.75, color="k")
        sol["Prad"].plot(ax=ax, linewidth=0.75, color="r", linestyle="dashed")
        plt.show()
