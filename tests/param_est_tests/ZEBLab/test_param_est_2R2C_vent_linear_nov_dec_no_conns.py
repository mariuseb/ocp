...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "2R2C_det_vent_no_conns.json")
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        plt.show()
        params.to_csv("results/params_envelope_2R2C_linear_no_conns.csv", index=True)
        print(params)
    # dump for plots:
    sol.to_csv("results/linear_in_training_traj_2R2C_no_conns.csv", index=True)
