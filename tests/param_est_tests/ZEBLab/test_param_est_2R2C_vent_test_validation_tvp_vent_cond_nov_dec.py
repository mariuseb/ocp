...
if __name__ == "__main__":
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        plt.show()
        params.to_csv("results/params_envelope_tvp_2R2C.csv", index=True)
        print(params)
    # dump for plots:
    sol.to_csv("results/tvp_in_training_traj_2R2C.csv", index=True)
    ...
    # set last three to zero:
    p_mod[4:] = 0
    p_base.to_csv("results/tvp_params_base_2R2C.csv", index=True)
    p_mod.to_csv("results/tvp_params_mod_2R2C.csv", index=True)
