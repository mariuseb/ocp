...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "3R2C_det_vent_all_conns.json")
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        plt.show()
        params.to_csv("results/params_envelope_linear_3R2C.csv", index=True)
        print(params)
    # dump for plots:
    sol.to_csv("results/L_in_training_traj_3R2C.csv", index=True)
    ...
    #plt.show()
    res.to_csv("results/L_validation_traj_3R2C.csv", index=True)
