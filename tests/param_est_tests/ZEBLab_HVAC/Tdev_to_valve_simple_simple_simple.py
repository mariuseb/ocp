...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "Tdev_to_valve_simple.json")
    ...
    # take subset of data:
    #start = pd.Timestamp("2024-01-14 00:00")
    #stop = pd.Timestamp("2024-01-28 00:00")
    ...
    y_data["heat_mode"] = 1
    y_data["heat_mode"][y_data.Tdev == 0] = 0
