...
params = pd.DataFrame(pd.read_csv("results/params_envelope_2R2C_linear.csv", index_col=0))
# to get estimated x0, read trajectory:
sol = pd.read_csv("results/linear_in_training_traj_2R2C.csv", index_col=0)
...
result_gen.make_journal_plot(
                             y_data,
                             x0, 
                             "linear_2R2C_journal_plot_training"
                             )
result_gen.plot_residual_dist(
                              y_data,
                             "linear_2R2C_residual_plot_training"
                             )
...
result_gen.make_journal_plot(
                             y_data,
                             x0, 
                             "linear_2R2C_journal_plot_validation"
                             )
result_gen.plot_residual_dist(
                              y_data,
                             "linear_2R2C_residual_plot_validation"
                             )
