...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "2R2C_det_vent_tvp_vent_cond_adj.json")
    ...
    p_mod[4:] = 0
    p_base.to_csv("results/tvp_params_base_2R2C_vent_adj.csv", index=True)
    p_mod.to_csv("results/tvp_params_mod_2R2C_vent_adj.csv", index=True)
    print(params)