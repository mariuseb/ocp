...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "2R2C_int_gains_sep_bal_vent_weekend_vent.json")
    #ekf_config = "configs/ekf_configs/2R2C_envelope_EKF_int_gains_sep_bal_vent.json"
    ekf_config = "configs/ekf_configs/2R2C_envelope_EKF_int_gains_sep_bal_vent_tvp_weekend_vent.json"
