...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "2R2C_int_gains_sep_bal_vent_weekend_alt.json")
    #ekf_config = "configs/ekf_configs/2R2C_envelope_EKF_int_gains_sep_bal_vent.json"
    ekf_config = "configs/ekf_configs/2R2C_envelope_EKF_int_gains_sep_bal_vent_tvp_weekend.json"
    ...
    kwargs = {
        ...
        "u_nom": [12]*7 + [1E3,1E3,1E3,1E3,10,10,1],
        "u_nom_b ": [289.15]*7 + [0]*7,
        "y_nom": [12],
        "y_nom_b": [289.15],
        #"slack": True
    ...
    priors = {
        "Rie": 0.250/A, # m²K / W 
        "Rie_w": 0.250*2/A, # m²K / W 
        "Rea": 2.250/A, # m²K / W 
        "Rea_w": 2.250*2/A, # m²K / W 
        "Ci": 9.50*3600*A, # Wh / m²K
        "Ci_w": 9.50*3600*A/2, # Wh / m²K
        "Ce": 112*3600*A, # Wh / m²K
        "Ce_w": 112*3600*A/2, # Wh / m²K
        "Ai": 10, # m²
        "alpha_vent_sup": 1,
        "alpha_vent_ext": 1,
        "alpha_int_plugs": 1,
    ...
    for delta_day in range(20):
        ...
        if not y_data.Ti.isna().any():
            ...
            if float(test_metrics.loc["mse"]) > 0.5:
                # check what happens
                print(params)
            p0 = params.values
