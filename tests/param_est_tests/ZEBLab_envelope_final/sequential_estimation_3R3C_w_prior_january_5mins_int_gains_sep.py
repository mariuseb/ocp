...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "3R3C_int_gains_sep.json")
    ekf_config = "configs/ekf_configs/3R3C_envelope_EKF_int_gains_sep.json"
