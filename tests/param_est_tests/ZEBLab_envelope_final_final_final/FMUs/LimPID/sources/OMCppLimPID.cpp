...
LimPID::LimPID(IGlobalSettings* globalSettings, shared_ptr<ISimObjects> simObjects)
    ...
    ,_PI_P_Dzero_P_y_(getSimVars()->initRealVar(2))
    ,_PI_P_I_P_u_(getSimVars()->initRealVar(3))
    ,_PI_P_I_P_y_reset_internal_(getSimVars()->initRealVar(4))
    ,_PI_P_P_P_y_(getSimVars()->initRealVar(5))
    ,_PI_P_addP_P_y_(getSimVars()->initRealVar(6))
    ,_PI_P_addPID_P_y_(getSimVars()->initRealVar(7))
    ,_PI_P_addSat_P_y_(getSimVars()->initRealVar(8))
    ,_PI_P_controlError_(getSimVars()->initRealVar(9))
    ,_PI_P_gainPID_P_y_(getSimVars()->initRealVar(10))
    ,_PI_P_gainTrack_P_y_(getSimVars()->initRealVar(11))
    ,_PI_P_y_reset_internal_(getSimVars()->initRealVar(12))
    ,_Tmeas_(getSimVars()->initRealVar(13))
    ,_Tset_(getSimVars()->initRealVar(14))
    ,_u_val_(getSimVars()->initRealVar(15))
    ,_PI_P_I_P_trigger_internal_(getSimVars()->initBoolVar(0))
    ,_PI_P_Dzero_P_k_(getSimVars()->initRealVar(16))
    ,_PI_P_I_P_k_(getSimVars()->initRealVar(17))
    ,_PI_P_I_P_y_reset_(getSimVars()->initRealVar(18))
    ,_PI_P_I_P_y_start_(getSimVars()->initRealVar(19))
    ,_PI_P_Nd_(getSimVars()->initRealVar(20))
    ,_PI_P_Ni_(getSimVars()->initRealVar(21))
    ,_PI_P_P_P_k_(getSimVars()->initRealVar(22))
    ,_PI_P_Td_(getSimVars()->initRealVar(23))
    ,_PI_P_Ti_(getSimVars()->initRealVar(24))
    ,_PI_P_addI_P_k1_(getSimVars()->initRealVar(25))
    ,_PI_P_addI_P_k2_(getSimVars()->initRealVar(26))
    ,_PI_P_addI_P_k3_(getSimVars()->initRealVar(27))
    ,_PI_P_addP_P_k1_(getSimVars()->initRealVar(28))
    ,_PI_P_addP_P_k2_(getSimVars()->initRealVar(29))
    ,_PI_P_addPID_P_k1_(getSimVars()->initRealVar(30))
    ,_PI_P_addPID_P_k2_(getSimVars()->initRealVar(31))
    ,_PI_P_addPID_P_k3_(getSimVars()->initRealVar(32))
    ,_PI_P_addSat_P_k1_(getSimVars()->initRealVar(33))
    ,_PI_P_addSat_P_k2_(getSimVars()->initRealVar(34))
    ,_PI_P_gainPID_P_k_(getSimVars()->initRealVar(35))
    ,_PI_P_gainTrack_P_k_(getSimVars()->initRealVar(36))
    ,_PI_P_k_(getSimVars()->initRealVar(37))
    ,_PI_P_limiter_P_uMax_(getSimVars()->initRealVar(38))
    ,_PI_P_limiter_P_uMin_(getSimVars()->initRealVar(39))
    ,_PI_P_revAct_(getSimVars()->initRealVar(40))
    ,_PI_P_wd_(getSimVars()->initRealVar(41))
    ,_PI_P_wp_(getSimVars()->initRealVar(42))
    ,_PI_P_xd_start_(getSimVars()->initRealVar(43))
    ,_PI_P_xi_start_(getSimVars()->initRealVar(44))
    ,_PI_P_yMax_(getSimVars()->initRealVar(45))
    ,_PI_P_yMin_(getSimVars()->initRealVar(46))
    ,_PI_P_y_reset_(getSimVars()->initRealVar(47))
    ,_PI_P_y_start_(getSimVars()->initRealVar(48))
    ,_ki_(getSimVars()->initRealVar(49))
    ,_kp_(getSimVars()->initRealVar(50))
    ...
    ,__omcQ_24outputAlias_5Fu_5Fval_(getSimVars()->initRealVar(15))
    ,_PI_P_P_P_u_(getSimVars()->initRealVar(6))
    ,_PI_P_addI_P_u1_(getSimVars()->initRealVar(14))
    ,_PI_P_addI_P_u2_(getSimVars()->initRealVar(13))
    ,_PI_P_addI_P_u3_(getSimVars()->initRealVar(11))
    ,_PI_P_addI_P_y_(getSimVars()->initRealVar(3))
    ,_PI_P_addP_P_u1_(getSimVars()->initRealVar(14))
    ,_PI_P_addP_P_u2_(getSimVars()->initRealVar(13))
    ,_PI_P_addPID_P_u1_(getSimVars()->initRealVar(5))
    ,_PI_P_addPID_P_u2_(getSimVars()->initRealVar(2))
    ,_PI_P_addPID_P_u3_(getSimVars()->initRealVar(0))
    ,_PI_P_addSat_P_u1_(getSimVars()->initRealVar(15))
    ,_PI_P_addSat_P_u2_(getSimVars()->initRealVar(10))
    ,_PI_P_gainPID_P_u_(getSimVars()->initRealVar(7))
    ,_PI_P_gainTrack_P_u_(getSimVars()->initRealVar(8))
    ,_PI_P_limiter_P_u_(getSimVars()->initRealVar(10))
    ,_PI_P_limiter_P_y_(getSimVars()->initRealVar(15))
    ,_PI_P_u_m_(getSimVars()->initRealVar(13))
    ,_PI_P_u_s_(getSimVars()->initRealVar(14))
    ,_PI_P_y_(getSimVars()->initRealVar(15))
{
    initConstVals();
    initStateVars();
    initDerivativeVars();
...
void LimPID::getReal(double* z)
{
  ...
  memcpy(z,real_vars,51*sizeof(double));
}
