...
/*
*/
void LimPIDInitialize::initParameterEquation_26()
{
  SystemDefaultImplementation::setBoolStartValue(_PI_P_limiter_P_limitsAtInit_, true, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_27()
{
  SystemDefaultImplementation::setBoolStartValue(_PI_P_limiter_P_strict_, true, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_28()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_limiter_P_uMin_, 0.0, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_29()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_limiter_P_uMax_, 1.0, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_30()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_k_, _kp_, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_31()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_gainTrack_P_k_, division(1.0,(_PI_P_Ni_ * _PI_P_k_),!_initial,"PI.Ni * PI.k"), true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_32()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_gainPID_P_k_, _PI_P_k_, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_33()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_addSat_P_k2_, -1.0, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_34()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_addSat_P_k1_, 1.0, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_35()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_addI_P_k3_, 1.0, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_36()
{
  double tmp3;
...
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_Ti_, _ki_, true);
}
/*
*/
void LimPIDInitialize::initParameterEquation_50()
{
  SystemDefaultImplementation::setRealStartValue(_PI_P_I_P_k_, division(1.0,_PI_P_Ti_,!_initial,"PI.Ti"), true);
}
/*
*/
...
{
  string tmp4;
  /*#modelicaLine [/home/marius/Desktop/modelica/modelica-buildings/Buildings 8.0.0/Controls/Continuous/LimPID.mo:11:3-11:51]*/

  if (!(_PI_P_k_ >= 0.0))
  {
    string tmp4 = omcpp::to_string(_PI_P_k_);
    LOGGER_WRITE(("Variable violating min constraint: 0.0 <= PI.k, has value: " + tmp4), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_67()
{
  ...
  if (!(_PI_P_Ni_ >= 1e-13))
  {
    string tmp5 = omcpp::to_string(_PI_P_Ni_);
    LOGGER_WRITE(("Variable violating min constraint: 1e-13 <= PI.Ni, has value: " + tmp5), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_68()
{
  ...
  {
    string tmp6 = omcpp::to_string(_PI_P_I_P_reset_);
    LOGGER_WRITE(("Variable violating min/max constraint: Buildings.Types.Reset.Disabled <= PI.I.reset <= Buildings.Types.Reset.Input, has value: " + tmp6), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_69()
{
  ...
  {
    string tmp7 = omcpp::to_string(_PI_P_I_P_initType_);
    LOGGER_WRITE(("Variable violating min/max constraint: Modelica.Blocks.Types.Init.NoInit <= PI.I.initType <= Modelica.Blocks.Types.Init.InitialOutput, has value: " + tmp7), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
{
  string tmp8;
  /*#modelicaLine [/home/marius/Desktop/modelica/modelica-buildings/Buildings 8.0.0/Controls/Continuous/LimPID.mo:12:3-15:73]*/

  if (!(_PI_P_Ti_ >= 1e-60))
  {
    string tmp8 = omcpp::to_string(_PI_P_Ti_);
    LOGGER_WRITE(("Variable violating min constraint: 1e-60 <= PI.Ti, has value: " + tmp8), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_71()
{
  ...
  if (!(_PI_P_wp_ >= 0.0))
  {
    string tmp9 = omcpp::to_string(_PI_P_wp_);
    LOGGER_WRITE(("Variable violating min constraint: 0.0 <= PI.wp, has value: " + tmp9), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_72()
{
  ...
  {
    string tmp10 = omcpp::to_string(_PI_P_reset_);
    LOGGER_WRITE(("Variable violating min/max constraint: Buildings.Types.Reset.Disabled <= PI.reset <= Buildings.Types.Reset.Input, has value: " + tmp10), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_73()
{
  ...
  {
    string tmp11 = omcpp::to_string(_PI_P_initType_);
    LOGGER_WRITE(("Variable violating min/max constraint: Modelica.Blocks.Types.InitPID.NoInit <= PI.initType <= Modelica.Blocks.Types.InitPID.DoNotUse_InitialIntegratorState, has value: " + tmp11), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_74()
{
  ...
  if (!(_PI_P_Nd_ >= 1e-13))
  {
    string tmp12 = omcpp::to_string(_PI_P_Nd_);
    LOGGER_WRITE(("Variable violating min constraint: 1e-13 <= PI.Nd, has value: " + tmp12), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_75()
{
  ...
  if (!(_PI_P_wd_ >= 0.0))
  {
    string tmp13 = omcpp::to_string(_PI_P_wd_);
    LOGGER_WRITE(("Variable violating min constraint: 0.0 <= PI.wd, has value: " + tmp13), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_76()
{
  ...
  if (!(_PI_P_Td_ >= 0.0))
  {
    string tmp14 = omcpp::to_string(_PI_P_Td_);
    LOGGER_WRITE(("Variable violating min constraint: 0.0 <= PI.Td, has value: " + tmp14), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
/*
...
void LimPIDInitialize::initParameterEquation_77()
{
  ...
  {
    string tmp15 = omcpp::to_string(_PI_P_controllerType_);
    LOGGER_WRITE(("Variable violating min/max constraint: Modelica.Blocks.Types.SimpleController.P <= PI.controllerType <= Modelica.Blocks.Types.SimpleController.PID, has value: " + tmp15), LC_MODEL, LL_WARNING);
  }
  /*#endModelicaLine*/
}
...
{
  initParameterEquation_26();
  initParameterEquation_27();
  initParameterEquation_28();
  initParameterEquation_29();
  initParameterEquation_30();
  initParameterEquation_31();
  initParameterEquation_32();
  initParameterEquation_33();
  initParameterEquation_34();
  initParameterEquation_35();
  initParameterEquation_36();
