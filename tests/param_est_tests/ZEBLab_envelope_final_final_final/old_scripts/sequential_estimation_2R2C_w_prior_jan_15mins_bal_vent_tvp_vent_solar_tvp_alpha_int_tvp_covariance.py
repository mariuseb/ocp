...
if __name__ == "__main__":
    ...
    kwargs = {
        "x_nom": 12,
        "x_nom_b": 289.15,
        "z_nom": [1e-2,1e-1,1E6,1E6,10,1,1],
        "z_nom_b": [0]*7,
    ...
    cfg_path = os.path.join(
                            "configs", 
                            "2R2C_int_gains_sep_bal_vent_vent_alpha_int_tvp_solar_tvp.json"
                            )
    ekf_config = os.path.join(
                              "configs",
                              "ekf_configs",
                              "2R2C_envelope_EKF_int_gains_sep_bal_vent_tvp_vent_solar_tvp_alpha_int_tvp_covar_tvp.json"
                              )
