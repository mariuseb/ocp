...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join(
                            "configs", 
                            "2R2C_int_gains_sep_bal_vent_weekend_vent.json"
                            )
    ekf_config = os.path.join(
                              "configs",
                              "ekf_configs",
                              "2R2C_envelope_EKF_int_gains_sep_bal_vent_tvp_weekend_vent.json"
                              )
    ...
    Q = np.array(
                 [
                  [4.97083350e-02, 0.00000000e+00],
                  [0.00000000e+00, 4.54118906e-05]
                 ]
                )**2
    P0 = np.array([
                   [ 0.08367146,  0.        ],
    ...
    x0 = np.array([21.09221714, 18.14845659])
    R = np.array([[2.60714131e-05]])
    ...
    result_gen.make_journal_plot_alt("half_day_nov_dec_2023", training=False)
