...
if __name__ == "__main__":
    ...
    ekf_config = os.path.join(
                              "configs",
                              "ekf_configs",
                              "2R2C_envelope_EKF_int_gains_sep_bal_vent_covar_tvp.json"
                              )
    ...
    result_gen.residuals.to_csv("to_CTSMR/residuals_QR_opt_nov_no_solar_tvp_no_covar_opt_no_tvp.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_nov_no_solar_tvp_no_covar_opt_no_tvp.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_nov_no_solar_tvp_no_covar_opt_no_tvp.csv")
    
    residuals = pd.read_csv("to_CTSMR_covar_opt/residuals_QR_opt_nov_covar_opt_H=1.csv")
    residuals = result_gen.residuals
    ax = autocorrelation_plot(residuals["0"])
    ax.set_xlim([0,400])
    plt.show()
