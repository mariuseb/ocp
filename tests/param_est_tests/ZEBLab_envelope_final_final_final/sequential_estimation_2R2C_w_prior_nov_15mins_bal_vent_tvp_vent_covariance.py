...
if __name__ == "__main__":
    ...
    result_gen.residuals.to_csv("to_CTSMR/residuals_QR_opt_nov_no_solar_tvp_no_covar_opt.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_nov_no_solar_tvp_no_covar_opt.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_nov_no_solar_tvp_no_covar_opt.csv")
