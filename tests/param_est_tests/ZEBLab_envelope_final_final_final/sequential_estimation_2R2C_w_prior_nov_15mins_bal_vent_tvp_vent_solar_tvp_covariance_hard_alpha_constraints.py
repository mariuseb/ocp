...
if __name__ == "__main__":
    ...
    result_gen.make_data_plot_alt("training_nov_2023_day13", day=13)
    result_gen.make_journal_plot_alt("whole_day_nov_dec_2023", training=False)
    
    result_gen.residuals.to_csv("to_CTSMR/residuals_QR_opt_nov_H=1.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_nov_H=1_alpha_hard_constraints.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_nov_H=1_alpha_hard_constraints.csv")
    ...
    params[["Ai_high"]].plot(ax=axes[4])
    params[["alpha_vent_sup", "alpha_int_lig", "alpha_int_plugs"]].plot(ax=axes[5])
    plt.show()
