...
#define MODEL_GUID "{8ccb933f-74b6-493f-b352-6167edd0125e}"
...
LimPIDFMU *createSystemFMU(IGlobalSettings *globalSettings) {
  ...
  simObjects->LoadSimVars("LimPID", 51, 5, 7, 0, 63, 1, 0);
...
unsigned int LimPIDFMU::_inputRefs[] = {13, 14, 49, 50};
// value references of real discrete states and outputs
unsigned int LimPIDFMU::_outputRefs[] = {15};
