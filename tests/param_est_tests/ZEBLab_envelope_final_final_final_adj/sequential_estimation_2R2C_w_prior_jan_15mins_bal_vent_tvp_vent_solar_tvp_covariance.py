...
if __name__ == "__main__":
    ...
    Data.data.T_219_TR4.loc["2024-01-06 10:40":"2024-01-06 13:40"] = np.nan
    Data.data.T_219_TR3.loc["2024-01-06 10:45":"2024-01-06 11:45"] = np.nan
    """
    ...
    result_gen.make_journal_plot_alt("training_jan_2024_day0")
    result_gen.make_journal_plot_alt("training_jan_2024_day13", day=13)
    result_gen.make_data_plot_alt("training_data_jan_2024_day0")
    result_gen.make_data_plot_alt("training_data_jan_2024_day13", day=13)
    result_gen.make_journal_plot_alt("whole_day_jan_2024", training=False)
    
    result_gen.residuals.to_csv("to_CTSMR/residuals_QR_opt_january_covar_opt.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_jan_covar_opt.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_jan_covar_opt.csv")
    ...
    result_gen.residuals.to_csv("residuals_QR_opt_january_covar_opt_1e-2.csv")
