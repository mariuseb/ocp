...
if __name__ == "__main__":
    ...
    result_gen.residuals.to_csv("to_CTSMR/residuals_tvp_nov_covar_non_opt_jan_H=1.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_nov_covar_non_opt_jan_H=1.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_nov_covar_non_opt_jan_H=1.csv")
    print(val_metrics)