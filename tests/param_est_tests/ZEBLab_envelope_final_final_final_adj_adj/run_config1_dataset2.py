...
if __name__ == "__main__":
    ...
    plot_residuals(res, res, "res_dist_config1_dataset2")
...
#    result_gen.make_journal_plot_alt("whole_day_jan_2024", training=False)
    result_gen.residuals.to_csv("to_CTSMR/residuals_config1_dataset2.csv")
    params_hist.to_csv("params_config1_dataset2.csv")
    train_metrics.to_csv("metrics/train_metrics_config1_dataset2.csv")
    val_metrics.to_csv("metrics/val_metrics_config1_dataset2.csv")
