...
#    result_gen.make_journal_plot_alt("whole_day_jan_2024", training=False)
    result_gen.residuals.to_csv("to_CTSMR/residuals_config5_dataset1.csv")
    params_hist.to_csv("params_config5_dataset1.csv")
    train_metrics.to_csv("metrics/train_metrics_config5_dataset1.csv")
    val_metrics.to_csv("metrics/val_metrics_config5_dataset1.csv")
