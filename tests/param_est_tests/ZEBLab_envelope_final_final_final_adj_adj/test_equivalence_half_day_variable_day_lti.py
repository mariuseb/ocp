...
if __name__ == "__main__":
    ...
    result_gen.residuals.to_csv("to_CTSMR/residuals_tvp_jan_non_covar_opt_jan_H=1.csv")
    params_hist.to_csv("LTI_reiden_no_covar_opt_jan.csv")
    train_metrics.to_csv("metrics/train_metrics_tvp_jan_non_covar_opt_jan_H=1.csv")
    val_metrics.to_csv("metrics/val_metrics_tvp_jan_non_covar_opt_jan_H=1.csv")
