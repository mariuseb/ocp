...
if __name__ == "__main__":
    ...
    params_hist.to_csv("LTV_reiden_no_covar_opt_nov.csv")
    train_metrics.to_v("metrics/train_metrics_LTV_reiden_covar_opt.csv")
    val_metrics.to_csv("metrics/val_metrics_LTV_reiden_covar_opt.csv")
