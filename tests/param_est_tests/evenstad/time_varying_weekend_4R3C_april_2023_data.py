...
if __name__ == "__main__":
    ...
    cfg_path = "configs/2R2C_det_vent_single_tvp_weeknd_no_constr.json"
    meas = pd.read_csv("Laaven_MeasData_2023-01-18___2023-06-04.csv", index_col=0)
    
    all_data, temp_cols = prepare_data(meas)
    """
    wea = pd.read_csv("Laaven_Weather_2023-01-18___2023-06-04.csv", index_col=0)
    ...
    stop = pd.Timestamp("2023-04-15 00:00")
