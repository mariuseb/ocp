...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "4R2C_inf_Tsup.json")
    ...
    kwargs = {
        ...
        "u_nom": 1,
        "r_nom": 1,
        "p_nom": [1E-5,1E-4,1E-5,300,1E8,1E9,1E2,1,1E3,1,1],
        "y_nom": 1,
        }
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        v2 = v2/eta
        param_est.nlp["f"] = R[0,0]*0.5*ca.dot(v1, v1) + R[1,1]*ca.dot(v2, v2)
