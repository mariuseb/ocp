...
if __name__ == "__main__":
    ...
    kwargs = {
        "x_nom": 12,
        "x_nom_b": 289.15,
        "u_nom": [1E6,1,1,12,12,12,12,12],
        "u_nom_b": [0,0,0,289.15,289.15,289.15,289.15,289.15],
        "r_nom": [12,300,1E6,1E6,1E6],
        "r_nom_b": [289.15,0,0,0,0],
        #"p_nom": [1E-5,1E-4,1E8,1E9,1E2,1,1E3,1,12],
        #"p_nom_b": [0,0,0,0,0,0,0,0,289.15],
        "y_nom": [12,1E6,12],
        "y_nom_b": [289.15,0,289.15]
    }
    ...
    Ph_air = y_data.ahu_reaFloSupAir*params["cp_air"]*(y_data["ahu_reaTSupAir"] - y_data["ahu_reaTHeaRec"])
    _v2 = (y_data["Pvent"]*params["eta_hex1"] - Ph_water)/params["eta_hex1"]
    _v3 = (Ph_water*params["eta_hex2"] - Ph_air)/params["eta_hex2"]
    print(_v2 - sol["v2"])
    print(_v3 - sol["v3"])
