...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "4R2C_inf_vent_TRec.json")
    ...
    y_data["y3"] = y_data["ahu_reaTSupAir"]
    y_data["y4"] = y_data["ahu_reaTHeaRec"]
    ...
    kwargs = {
        ...
        "z_nom": 12, 
        "z_nom_b": 289.15,
        "u_nom": [1E6,1,1,1,12,12,12,12,12],
        "u_nom_b": [0,0,0,0,289.15,289.15,289.15,289.15,289.15],
        "r_nom": [12,300,1E6,1E6,1E6],
        "r_nom_b": [289.15,0,0,0,0],
        #"p_nom": [1E-5,1E-4,1E8,1E9,1E2,1,1E3,1,12],
        #"p_nom_b": [0,0,0,0,0,0,0,0,289.15],
        "y_nom": [12,1E6,12,12,1,12],
        "y_nom_b": [289.15,0,289.15,289.15,0,289.15]
    }
    ...
    Ph_air = y_data.ahu_reaFloSupAir*params["cp_air"]*(y_data["ahu_reaTSupAir"] - y_data["ahu_reaTHeaRec"])/params["eta_hex2"]
    ...
    (y_data.Pvent*params["eta_hex1"]).plot(ax=ax, drawstyle="steps-post")
