...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "u_nom": [1]*4 + [12],
        "u_nom_b ": [0]*4 + [289.15],
        "y_nom": [12,12,1E6,1E6,12,12,1,1,1,1,12,1E6,1],
        "y_nom_b": [289.15,289.15,0,0,289.15,289.15,0,0,0,0,289.15,0,0],
        #"slack": True
        "slack": False
    }
         
    cfg_path = "configs/HVAC_DAE.json"
    ...
    x_guess = y_data[["Tret", "Tret","Tsup_air"]].values.T        
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = y_data[["Tret","Tsup"]].plot(drawstyle="steps-post")
        ax1 = ax.twinx()
        y_data["rad_val"].plot(ax=ax1, color="g", drawstyle="steps-post")
        plt.show()
