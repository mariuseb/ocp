...
if __name__ == "__main__":
    ...
    data["rad_val_set"] = data["rad_val"].shift(-1) 
    #data["rad_val_set"] = data["rad_val"]
    ...
    cfg_path = "configs/HVAC_model_DAE_Tret_Tsup_valve_diff_var.json"
    ...
    x_guess = y_data[["Tsup","Tret","Tsup","rad_val"]].values.T        
    N = len(y_data) 
    ...
    params.to_csv("HVAC_DAE_model_latest_Tsup_Tret_rad_val_diff_var.csv", index=True)   