...
if __name__ == "__main__":
    ...
    ax1 = ax.twinx()
    data["rad_val"].plot(ax=ax1, color="g", linewidth=0.75, drawstyle="steps-post")
    ax.legend()
    ...
    kwargs = {
        "z_nom": [12,1E6,1E6,1,1,1,1,12,12,12,1,1,1,1E6],
        "z_nom_b": [289.15,0,0,0,0,0,0,289.15,289.15,289.15,0,0,0,0],
        "r_nom": [12,300,1E5,1E5,1E5],
        "r_nom_b": [289.15,0,0,0,0],
        "u_nom": [12,1,1,1,1,12,12,12],
        "u_nom_b ": [289.15,0,0,0,0,289.15,289.15,289.15],
        "y_nom": [12,1E6,1E6,12,12,1,1,1,1,12,1E6,1],
        "y_nom_b": [289.15,0,0,289.15,289.15,0,0,0,0,289.15,0,0],
        #"slack": True
        "slack": False
    }
         
    cfg_path = "configs/HVAC_algebraic_inc_Tret.json"
    ...
    params.to_csv("HVAC_model_latest.csv", index=True)   
    """
