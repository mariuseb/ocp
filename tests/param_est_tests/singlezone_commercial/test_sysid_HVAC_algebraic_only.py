...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "u_nom": [12,1,1,1,1,12,12,12,12],
        "u_nom_b ": [289.15,0,0,0,0,289.15,289.15,289.15,289.15],
        "y_nom": [1E6,1E6,12,12,1,1,1,1,12,1E6,1],
        "y_nom_b": [0,0,289.15,289.15,0,0,0,0,289.15,0,0],
        #"slack": True
        "slack": False
    }
         
    cfg_path = "configs/HVAC_algebraic_only.json"
