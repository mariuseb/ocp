...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "y_nom": [1E6,1E6,12,12,1,12,12,12],
        "y_nom_b": [0,0,289.15,289.15,0,289.15,289.15,289.15],
        #"slack": True
        "slack": False
    }
    ...
    cfg_path = "configs/Tsup_air_Tret_coi_Prad_rad_Tret_Trec_less_measurements.json"
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = sol["rad_flo"].plot(color="r", linewidth=0.75)
        y_data["y6"].plot(ax=ax, color="k", linestyle="dashed", linewidth=0.75)
        #sol[var.name()].plot(ax=ax, color="r", linewidth=0.75)
        ax.legend()
        plt.show()
        
        ax = sol["coi_flo"].plot(color="r", linewidth=0.75)
        y_data["y7"].plot(ax=ax, color="k", linestyle="dashed", linewidth=0.75)
        #sol[var.name()].plot(ax=ax, color="r", linewidth=0.75)
        ax.legend()
        plt.show()
        
        ax = sol["tot_flo"].plot(color="r", linewidth=0.75)
        y_data["y8"].plot(ax=ax, color="k", linestyle="dashed", linewidth=0.75)
        #sol[var.name()].plot(ax=ax, color="r", linewidth=0.75)
        ax.legend()
        plt.show()
