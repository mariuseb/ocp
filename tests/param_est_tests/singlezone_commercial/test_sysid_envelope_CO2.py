...
if __name__ == "__main__":
    ...
    cfg_path = "configs/3R2C_CO2.json"
    ...
    kwargs = {
        ...
        "z_nom": [1,1,1],
        "z_nom_b": [0,0,0],
        "u_nom": [1E6,1E6,12,1,1,12,1,1,1],
        "u_nom_b": [0,0,289.15,0,0,289.15,0,0,0],
    ...
    x_guess = y_data[["Ti", "Ti", "CO2_in"]].values.flatten()
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = axes[0]
        sol["y1"].plot(ax=ax, color="k", linewidth=0.75)
        ...
        ax = axes[1]
        sol.y2.plot(drawstyle="steps-post", ax=ax, color="b")
        sol.CO2_in.plot(drawstyle="steps-post", color="k", linestyle="dashed")
        plt.show()        
        print(params)