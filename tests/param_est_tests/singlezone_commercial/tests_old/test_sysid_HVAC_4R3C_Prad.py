...
if __name__ == "__main__":
    ...
    cfg_path = "configs/3R2C_Prad.json"
    ...
    kwargs = {
        ...
        "z_nom": [1E6],
        "z_nom_b": [0],
        "u_nom": [1E6,12,1,1,1,12,12,1],
        "u_nom_b": [0,289.15,0,0,0,289.15,289.15,0],
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        sol["Prad"].plot(ax=ax, color="r", linestyle="dashed", linewidth=0.75)
        plt.show()
        
        print(params)
        
    params.to_csv("HVAC_model_3R2C_latest.csv", index=True)  