...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join("configs", "4R2C_inf_Tsup_int_gains_Pvent.json")
    ...
    y_data.ahu_reaTCoiSup_y.plot(ax=ax[0], drawstyle="steps-post")
    y_data.reaTCoiRet_y.plot(ax=ax[0], drawstyle="steps-post")
    ...
    kwargs = {
        ...
        "u_nom": 1,
        "r_nom": 1,
        "p_nom": [1E-5,1E-4,1E-5,300,1,1E3,1,1E8,1E9,1E2,1,1E3,1,1],
        "y_nom": 1,
        }
    ...
    Ph_model = sol["v2"] + sol["y2"]*params["eta"]
    ax = Ph_model.plot(color="k", drawstyle="steps-post", linestyle="dashed")
    #ax1 = ax.twinx()
