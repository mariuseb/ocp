...
if __name__ == "__main__":
    ...
    y_data["y7"] = y_data["deltaT"]
    
    ax = y_data.deltaT.plot(drawstyle="steps-post")
    ax1 = ax.twinx()
    (y_data.rad_flo/9).plot(ax=ax1, color="r", drawstyle="steps-post")
    plt.show()
    ...
    kwargs = {
        ...
        "y_nom": [12,12,12,1E6,1E6,12,12,1],
        "y_nom_b": [289.15,289.15,289.15,0,0,289.15,289.15,0],
        #"slack": True
        "slack": False
    }
    """
    ...
    cfg_path = "configs/HVAC_model_DAE_Trad_rad_flo_deltaT_alg.json"
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        R[3,3] = 0
        #R[3,3] = 0deltaT_nom*(regNonZeroPower(rad_val, n4, 1E-6))
        ...
        R[5,5] = 0
        R[6,6] = 1/np.var(y_data.deltaT)
        R[7,7] = 1/np.var(y_data.rad_flo)
        R[7,7] = 0
