...
if __name__ == "__main__":
    ...
    data_path = "closed_loop_results_300s.csv"
    ...
    cfg_path = "configs/HVAC_model_DAE_Tret_Tsup_Prad_to_env_almost_linear.json"
    #cfg_path = "configs/HVAC_model_DAE_Tret_Tsup_Prad_to_env_simpler.json"
    ...
    #param_guess["Crad"]["lb"] = param_guess["Crad"]["init"]/1000
    #param_guess["Crad"]["ub"] = param_guess["Crad"]["init"]*1000
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = sol["y4"].plot(color="r", drawstyle="steps-post", linestyle="dashed", linewidth=0.75)
        sol["y5"].plot(ax=ax, color="k", drawstyle="steps-post", linewidth=0.75, linestyle="dashed")
        sol["Prad_to_env"].plot(ax=ax, color="b", drawstyle="steps-post", linewidth=0.75, linestyle="dashed")
        sol["Prad"].plot(ax=ax, color="y", drawstyle="steps-post", linewidth=0.75, linestyle="dashed")
        ax.legend()
        #sol[var.name()].plot(ax=ax, color="r", linewidth=0.75)
        plt.show()
    ...
    sol.to_csv("HVAC_DAE_sol_latest_Tret_5min.csv", index=True)   