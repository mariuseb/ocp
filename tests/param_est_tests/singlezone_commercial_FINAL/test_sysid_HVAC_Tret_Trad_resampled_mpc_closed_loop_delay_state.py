...
if __name__ == "__main__":
    ...
    cfg_path = "configs/HVAC_model_DAE_Tret_Tsup_Prad_to_env_delay_state.json"
    ...
    #y_data = y_data[0:25]
    x_guess = y_data[["Trad","Tret","Tsup", "rad_flo"]].values.T        
    N = len(y_data) 
    
    #kwargs["x_nom"] = np.array([12]*3*N + [1]*N).reshape((4,N))
    #kwargs["x_nom_b"] = np.array([289.15]*3*N + [0]*N).reshape((4,N))
