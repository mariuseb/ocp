...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "u_nom": [1]*5 + [12],
        "u_nom_b ": [0]*5 + [289.15],
        "y_nom": [12,12,12,1E6,1],
        "y_nom_b": [289.15,289.15,289.15,0,0],
        #"slack": True
        "slack": False
    }
    """
    ...
    cfg_path = "configs/HVAC_model_DAE_Tret_Tsup.json"
    ...
    #y_data = y_data[0:10]
    x_guess = y_data[["Tret","Tsup"]].values.T        
    N = len(y_data) 
