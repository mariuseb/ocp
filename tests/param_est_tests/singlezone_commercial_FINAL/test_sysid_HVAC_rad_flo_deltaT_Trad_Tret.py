...
if __name__ == "__main__":
    ...
    cfg_path = "configs/HVAC_model_DAE_rad_flo_Tret_Trad.json"
    ...
    params.to_csv("HVAC_DAE_model_latest_Trad_Tret_1min.csv", index=True)   
    sol.to_csv("HVAC_DAE_sol_latest_Trad_Tret_1min.csv", index=True)   