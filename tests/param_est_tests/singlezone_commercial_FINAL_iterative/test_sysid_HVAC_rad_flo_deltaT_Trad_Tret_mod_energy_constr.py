...
if __name__ == "__main__":
    ...
    cfg_path = "configs/HVAC_model_DAE_rad_flo_Tret_Trad_mod_energy_constr.json"
    ...
    x_guess = y_data[["Tret", "Tret"]].values.T        
    N = len(y_data) 
    ...
    params.to_csv("HVAC_DAE_model_latest_Trad_Tret_mod_1min.csv", index=True)   
    sol.to_csv("HVAC_DAE_sol_latest_Trad_Tret_mod_1min.csv", index=True)   