...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "u_nom": [1]*5 + [12]*1,
        "u_nom_b ": [0]*5 + [289.15]*1,
        "y_nom": [12,12,12,1E6,12,1],
        "y_nom_b": [289.15,289.15,289.15,0,289.15,0],
        #"slack": True
        "slack": False
    }
    """
    ...
    cfg_path = "configs/HVAC_model_DAE_rad_flo_Tsup_Tret_Trad_mod.json"
    ...
    x_guess = y_data[["Tret", "Tret","Tsup"]].values.T        
    N = len(y_data) 
    ...
    params.to_csv("HVAC_DAE_model_latest_Tsup_Trad_Tret_mod_1min.csv", index=True)   
    sol.to_csv("HVAC_DAE_sol_latest_Tsup_Trad_Tret_mod_1min.csv", index=True)   