...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "z_nom": [1E6,1E6,1,1,1,1,12,12,12,12,1,1,1],
        "z_nom_b": [0,0,0,0,0,0,289.15,289.15,289.15,289.15,0,0,0],
        "r_nom": [12,300,1E5,1E5,1E5],
        "r_nom_b": [289.15,0,0,0,0],
        "u_nom": [12,1,1,1,1,12,12],
        "u_nom_b ": [289.15,0,0,0,0,289.15,289.15],
        "y_nom": [1E6,1E6,12,12,1,1,1,1,12,12,12,1],
        "y_nom_b": [0,0,289.15,289.15,0,0,0,0,289.15,289.15,289.15,0],
        #"slack": True
        "slack": False
    }
         
    cfg_path = "configs/Tsup_air_Tret_coi_Prad_rad_Tret_Trec_floExt.json"
