...
if __name__ == "__main__":
    ...
    kwargs = {
        ...
        "x_nom": 12,
        "x_nom_b": 289.15,
        "z_nom": [1E6,1E6,1,1,1,1,12,12,12,12,1,1,1E6],
        ...
        "y_nom": [1E6,1E6,12,12,1,1,1,1,12,12,12,12,1E6],
        "y_nom_b": [0,0,289.15,289.15,0,0,0,0,289.15,289.15,289.15,289.15,0],
        #"slack": True
        "slack": False
    }
         
    #cfg_path = "configs/Tsup_air_Tret_coi_Prad_rad_Tret_Trec.json"
    cfg_path = "configs/full_model_Pfan.json"
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        y = param_est.dae.y
        fig, _axes = plt.subplots(7,2, sharex=True)
        axes = _axes.flatten()
