...
def prepare_data(data):
    ...
    y_data["phi_int_plugs"] = data["phi_int_219_plugs"]
    y_data["phi_int_lig"] = data["phi_int_219_lig"]
    y_data["phi_int"] = data["phi_int_219_lig"] + data["phi_int_219_plugs"]
    # ventilation:
    y_data["T_ext_air"] = data["T_ext_air_219"] # + 273.15
    y_data["T_sup_air"] = data["T_sup_air_219"] # + 273.15
    y_data["V_ext_air"] = data["V_ext_air_219"]
    y_data["V_sup_air"] = data["V_sup_air_219"]
    y_data["ahu_reaFloSupAir"] =  data["V_sup_air_219"]*(1.292/3600)*1000
    y_data["ahu_reaFloExtAir"] =  data["V_ext_air_219"]*(1.292/3600)*1000
    # indoor temp:
    y_data["Ti"] = temps_219
    y_data.Ti[y_data.Ti > 30] = 30
