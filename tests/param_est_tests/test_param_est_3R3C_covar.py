...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join(get_opt_config_path(), "3R3C.json")
    ...
    ax[1].set_ylabel(r"Power [W]")test_param_est_2R2C_covar copy
    fig.tight_layout()
    plt.show()
    """
    ...
    param_guess = ca.DM([0.01,0.1,0.01,1E6,1E6,1E7,2])
    #param_guess = ca.DM([1.532625e-03,1.160423e-02,1.328633e+06,6.644898e+06,5.578587e+00])
    lbp = ca.DM([0.001,0.01,0.001,1E5,1E5,1E6,1])
    ubp = ca.DM([0.1,1,0.1,1E7,1E7,1E8,50])
