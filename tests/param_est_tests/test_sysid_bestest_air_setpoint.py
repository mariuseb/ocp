...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join(opt_config_base, "2R2C_setpoint.json")
    ...
    if PLOT_DATA:
        ...
        y_data["Tset"].plot(ax=ax, color="k", linestyle="dashed", drawstyle="steps-post")
        ...
        ax.legend(["Ti", "Tsup", "Tset", "Ta"], loc="upper left")
    ...
    #param_guess = ca.DM([0.01,0.01,1E6,1E7,5,500,0.9,0.001])
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        #Ph_inf = (sol["Tsup"] - sol["Ti"])*sol["UA_is"]*y_data["u_fan"]*sol["eta"]
