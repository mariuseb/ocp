...
if __name__ == "__main__":
    ...
    with Estimation(
        ...
        sol["P_to_rad"] = (sol["Tsup"] - sol["Trad"])*sol["rad_flo"]*4200
        ...
        sol["P_to_rad"].plot(linestyle="dashed", drawstyle="steps-post",ax=ax1, color="m", linewidth=0.75)
        plt.show()
        params.to_csv("envelope_model_alt.csv", index=True)
        print(params) 
