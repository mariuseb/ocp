...
if __name__ == "__main__":
    ...
    Trad_zero = rad_model["Trad"].iloc[0]
    x_guess[2,0] = Trad_zero
    lbx[2,0] = Trad_zero
    ubx[2,0] = Trad_zero
    """
    for param in ("Crad",):
    ...
    """
    params_hvac = pd.read_csv("rad_model_PRBS.csv", index_col=0)
    ...
    """
    # Trad_zero:
    param_guess["Trad_zero"] = {
        "init": rad_model["Trad"].iloc[0],
        "lb": rad_model["Trad"].iloc[0],
        "ub": rad_model["Trad"].iloc[0]
    }
    """
    ...
    with Estimation(
        ...
        sol["Prad_ENV"] = (rad_model["Tsup"] - sol["Trad"])*rad_model["rad_flo"]*4200
        ...
        params.to_csv("envelope_model_rad_first.csv", index=True)
        sol.to_csv("solution_rad_first.csv", index=True)
        print(params) 
