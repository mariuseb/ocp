...
if __name__ == "__main__":
    ...
    params_hvac = pd.read_csv("rad_model_normal_op.csv", index_col=0)
    ...
    with Estimation(
        ...
        plt.show()
        params.to_csv("envelope_model_rad_first_normal_op.csv", index=True)
        sol.to_csv("solution_rad_first_normal_op.csv", index=True)
        print(params) 
