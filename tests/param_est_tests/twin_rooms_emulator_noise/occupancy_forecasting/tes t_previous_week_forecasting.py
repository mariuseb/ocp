...
series = data["n_occ"].iloc[168:168*4]
series_as_last = data["n_occ"].iloc[0:168*3]
series.index = series_as_last.index

print(series.head())
ax = series.plot(color="k", drawstyle="steps-post")
series_as_last.plot(ax=ax, color="r", drawstyle="steps-post")
pyplot.show()
