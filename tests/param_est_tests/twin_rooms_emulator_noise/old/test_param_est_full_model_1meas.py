...
def prepare_est(data, A=66.7, load_optimal_rad=False):
    param_guess = {
                "Rie": 
                {
                    "init": 1e-2
    ...
    kwargs = {
        ...
        "r_nom": [12,1E4],
        "r_nom_b ": [289.15,0],
        "z_nom": [1e-1,12,1E4,1E4],
        "z_nom_b ": [0,289.15,0,0],
        "y_nom": [12,1e-1,1E4,12,12],
    ...
    if load_optimal_rad:
        params_rad = pd.read_csv("hvac_model_PRBS.csv", index_col=0)
...
if __name__ == "__main__":
    ...
    sysid using PRBS.
    """
    cfg_path = os.path.join("configs", "4R4C_3meas.json")
