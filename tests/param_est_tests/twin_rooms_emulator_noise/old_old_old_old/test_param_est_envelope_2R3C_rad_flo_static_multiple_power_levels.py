...
if __name__ == "__main__":
    ...
    sysid using PRBS.
    """
    cfg_path = os.path.join("configs", "2R3C_alt_static_rad_flo.json")
    ...
    with Estimation(
        ...
        #plt.close()
        #params_start.to_csv("radiator_model_params.csv", index=True)
        params.loc[[
            "dT_b",
            "dT_a",
            "Ta_dim",
        ...
        ].to_csv("radiator_model_params.csv", index=True)
