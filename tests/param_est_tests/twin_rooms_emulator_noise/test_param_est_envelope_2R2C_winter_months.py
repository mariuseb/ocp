...
if __name__ == "__main__":
    ...
    params_rad = pd.read_csv("radiator_NL_map.csv", index_col=0).squeeze()
    for month in ("jan", "feb", "mar", "apr", "nov", "dec"):
        ...
        #y_data["Prad"] = y_data["Prad"].fillna(0)
        ...
        with Estimation(
            ...
            for ndx in params_rad.index:
                params.loc[ndx] = params_rad.loc[ndx]
