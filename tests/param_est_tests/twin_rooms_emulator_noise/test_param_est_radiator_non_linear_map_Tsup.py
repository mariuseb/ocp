...
if __name__ == "__main__":
    ...
    sysid using PRBS.
    """
    cfg_path = os.path.join("configs", "NL_map_static_Tsup.json")
    ...
    with Estimation(
        ...
        ax = sol["y3"].plot(color="r", linewidth=0.75, drawstyle="steps-post")
        ...
        #plt.close()
        params.to_csv("radiator_NL_map_Tsup.csv", index=True)
