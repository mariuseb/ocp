...
if __name__ == "__main__":
    ...
    with Estimation(
        ...
        params_rad = pd.Series()
        params_env = ["Ci", "Ce", "Rie", "Rea", "Ai"]
        for param in params.index:
            if param not in params_env:
                params_rad.loc[param] = params.loc[param]
        
        #plt.close()
        params_rad.to_csv("2R3C_rad_model.csv", index=True)
