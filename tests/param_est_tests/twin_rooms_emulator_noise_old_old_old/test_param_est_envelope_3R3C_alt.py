...
if __name__ == "__main__":
    ...
    Tret_model = y_data["Tret_model"]
    Tret_model.index = y_data.dt_index
    """
    sysid, envelope.
    """
    cfg_path = os.path.join("configs", "3R3C_alt.json")
    data_path = os.path.join(
                            "twin_rooms_emulator_PRBS_mod_1min.csv"
                            )
    y_data, N, dt = prepare_data(
